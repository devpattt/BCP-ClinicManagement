...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Get the patient type from the dropdown.
    $patient_type = htmlspecialchars(trim($_POST['patient_type']));
    // If the patient type is Student, override student_number using the extra input.
    if ($patient_type === "Student" && isset($_POST['student_number']) && !empty(trim($_POST['student_number']))) {
          ...
          <div class="card">
            <div class="card-body">
              ...
              <form id="form1" method="post" action="../forms-elements.php">
                ...
                <!-- Updated: Patient type dropdown -->
                <div class="row mb-3">
                  <label for="patient_type" class="col-sm-2 col-form-label">Patient</label>
                  <div class="col-sm-10">
                ...
                <!-- New: Student Number input (hidden by default) -->
                <div class="row mb-3" id="studentNumberRow" style="display:none;">
                ...
                <!-- Year Level row remains unchanged -->
