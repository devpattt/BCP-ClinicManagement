...
<script>
  ...
  document.getElementById('generateDocBtn').addEventListener('click', function() {
    ...
    // Create DOC content using template literal.
...
<body>
  ...
  <div class="instructions">
    ...
    <ol>
      ...
      <li>No spaces, dashes, or extra characters are allowed.</li>
    </ol>
    <p>Example: <span class="sample">s21018803</span></p>
  </div>
  ...
  <pre>${validNumbers.join("\n")}</pre>
    ...
    // Create a Blob for the DOC content and trigger download.
  ...
  document.getElementById('generatePdfBtn').addEventListener('click', function() {
    ...
    // Guidelines text
    doc.setFontSize(12);
    var guidelineText = "Each student number must start with 's' followed by exactly 8 digits. No extra characters are allowed. Example: s21018803";
