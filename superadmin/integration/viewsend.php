...
if ($result) {
    while ($row = $result->fetch_assoc()) {
        ...
        // Download column – link to download.php with unique_id
        echo "<td><a href='download.php?unique_id=" . urlencode($row['unique_id']) . "' class='btn btn-link btn-sm'><i class='bi bi-download'></i></a></td>";
