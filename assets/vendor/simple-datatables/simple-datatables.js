            ...
            (function(global) {
                (function() {
                    ...
                    function m(t, e, s) {
                        ...
                        s.valueDiffing && (t.value && f(i, "HTMLButtonElement", "HTMLDataElement", "HTMLInputElement", "HTMLLIElement", "HTMLMeterElement", "HTMLOptionElement", "HTMLProgressElement", "HTMLParamElement") && (i.value = t.value),
                    ...
                    function b(t, e, s) {
                        ...
                        case s._const.modifyAttribute:
                            ...
                            f(i, "HTMLInputElement") && "value" === e[s._const.name] && (i.value = e[s._const.newValue]);
                            break;
                        ...
                        case s._const.modifyTextElement:
                            ...
                            f(i.parentNode, "HTMLTextAreaElement") && (i.parentNode.value = e[s._const.newValue]);
                            break;
                        ...
                        case s._const.addTextElement:
                            ...
                            f(i.parentNode, "HTMLTextAreaElement") && (i.parentNode.value = e[s._const.value]);
                            break;
                        default:
                    ...
                    var w = function(t) {
                      ...
                      , N = function(t) {
                        ...
                        return Object.prototype.hasOwnProperty.call(t, "attributes") && (e.attributes = h({}, t.attributes)),
                      ...
                      , V = function(t, e) {
                        for (var s = t.childNodes ? t.childNodes : [], i = e.childNodes ? e.childNodes : [], n = E(s.length, !1), a = E(i.length, !1), o = [], r = function() {
                            ...
                            var t = function(t, e, s, i) {
                                ...
                                for (var h = 0; h < o; h++)
                                    for (var p = t[h], f = 0; f < r; f++) {
                                        var m = e[f];
                                        s[h] || i[f] || !O(p, m, d, c) ? l[h + 1][f + 1] = 0 : (l[h + 1][f + 1] = l[h][f] ? l[h][f] + 1 : 1,
                            ...
                            t ? (o.push(t),
                            u([], new Array(t.length), !0).map(r).forEach((function(e) {
                    ...
                    function k(t, e) {
                        ...
                        if (f(t, "Text", "Comment"))
                            ...
                            e.valueDiffing && (f(t, "HTMLTextAreaElement") && (s.value = t.value),
                            f(t, "HTMLInputElement") && ["radio", "checkbox"].includes(t.type.toLowerCase()) && void 0 !== t.checked ? s.checked = t.checked : f(t, "HTMLButtonElement", "HTMLDataElement", "HTMLInputElement", "HTMLLIElement", "HTMLMeterElement", "HTMLOptionElement", "HTMLProgressElement", "HTMLParamElement") && (s.value = t.value),
                    ...
                    var P = {
                      ...
                      , H = function(t, e) {
                        ...
                        return t.replace(T, (function(r, l) {
                            ...
                            if (d) {
                                if ("svg" === (s = R(r, e.caseSensitive || o)).node.nodeName && (o = !0),
                                n++,
                                !s.voidElement && u && "<" !== u) {
                      ...
                      , I = function() {
                        function t(t, e, s) {
                            ...
                            this.diffcount = 0,
                            this.foundAll = !1,
                            this.debug && (this.t1Orig = "undefined" != typeof Element && f(t, "Element") ? k(t, this.options) : "string" == typeof t ? H(t, this.options) : JSON.parse(JSON.stringify(t)),
                        ...
                        t.prototype.findDiffs = function(t, e) {
                            ...
                            do {
                                ...
                                0 === (s = this.findNextDiff(t, e, [])).length && (x(t, e) || (this.foundAll ? console.error("Could not find remaining diffs!") : (this.foundAll = !0,
                                M(t),
                        ...
                        t.prototype.findOuterDiff = function(t, e, s) {
                            ...
                            if (Object.prototype.hasOwnProperty.call(t, "data") && t.data !== e.data)
                                return "#text" === t.nodeName ? [(new p).setValue(this.options._const.action, this.options._const.modifyTextElement).setValue(this.options._const.route, s).setValue(this.options._const.oldValue, t.data).setValue(this.options._const.newValue, e.data)] : [(new p).setValue(this.options._const.action, this.options._const.modifyComment).setValue(this.options._const.route, s).setValue(this.options._const.oldValue, t.data).setValue(this.options._const.newValue, e.data)];
                            for (n = t.attributes ? Object.keys(t.attributes).sort() : [],
                            a = e.attributes ? Object.keys(e.attributes).sort() : [],
                            o = n.length,
                            l = 0; l < o; l++)
                                i = n[l],
                                -1 === (r = a.indexOf(i)) ? d.push((new p).setValue(this.options._const.action, this.options._const.removeAttribute).setValue(this.options._const.route, s).setValue(this.options._const.name, i).setValue(this.options._const.value, t.attributes[i])) : (a.splice(r, 1),
                                t.attributes[i] !== e.attributes[i] && d.push((new p).setValue(this.options._const.action, this.options._const.modifyAttribute).setValue(this.options._const.route, s).setValue(this.options._const.name, i).setValue(this.options._const.oldValue, t.attributes[i]).setValue(this.options._const.newValue, e.attributes[i])));
                            for (o = a.length,
                            l = 0; l < o; l++)
                                i = a[l],
                                d.push((new p).setValue(this.options._const.action, this.options._const.addAttribute).setValue(this.options._const.route, s).setValue(this.options._const.name, i).setValue(this.options._const.value, e.attributes[i]));
                            return d
                        }
                        ,
                        t.prototype.findInnerDiff = function(t, e, s) {
                            ...
                            for (var h = 0; h < a; h += 1) {
                                var u = i[h]
                                  , f = n[h];
                                o && (u && !f ? "#text" === u.nodeName ? (r.push((new p).setValue(this.options._const.action, this.options._const.removeTextElement).setValue(this.options._const.route, s.concat(l)).setValue(this.options._const.value, u.data)),
                                l -= 1) : (r.push((new p).setValue(this.options._const.action, this.options._const.removeElement).setValue(this.options._const.route, s.concat(l)).setValue(this.options._const.element, N(u))),
                                l -= 1) : f && !u && ("#text" === f.nodeName ? r.push((new p).setValue(this.options._const.action, this.options._const.addTextElement).setValue(this.options._const.route, s.concat(l)).setValue(this.options._const.value, f.data)) : r.push((new p).setValue(this.options._const.action, this.options._const.addElement).setValue(this.options._const.route, s.concat(l)).setValue(this.options._const.element, N(f))))),
                                u && f && (!this.options.maxChildCount || a < this.options.maxChildCount ? r = r.concat(this.findNextDiff(u, f, s.concat(l))) : x(u, f) || (i.length > n.length ? ("#text" === u.nodeName ? r.push((new p).setValue(this.options._const.action, this.options._const.removeTextElement).setValue(this.options._const.route, s.concat(l)).setValue(this.options._const.value, u.data)) : r.push((new p).setValue(this.options._const.action, this.options._const.removeElement).setValue(this.options._const.element, N(u)).setValue(this.options._const.route, s.concat(l))),
                                i.splice(h, 1),
                                h -= 1,
                                l -= 1,
                                o -= 1) : i.length < n.length ? (r = r.concat([(new p).setValue(this.options._const.action, this.options._const.addElement).setValue(this.options._const.element, N(f)).setValue(this.options._const.route, s.concat(l))]),
                                i.splice(h, 0, N(f)),
                                o -= 1) : r = r.concat([(new p).setValue(this.options._const.action, this.options._const.replaceElement).setValue(this.options._const.oldValue, N(u)).setValue(this.options._const.newValue, N(f)).setValue(this.options._const.route, s.concat(l))]))),
                                l += 1
                            }
                        ...
                        t.prototype.attemptGroupRelocation = function(t, e, s, i, n) {
                            ...
                            }(t, e, s), h = c.gaps1, u = c.gaps2, f = t.childNodes.slice(), m = e.childNodes.slice(), g = Math.min(h.length, u.length), b = [], v = 0, _ = 0; v < g; _ += 1,
                            v += 1)
                                if (!n || !0 !== h[v] && !0 !== u[v]) {
                                    if (!0 === h[_])
                                        if ("#text" === (l = f[_]).nodeName)
                                            if ("#text" === m[v].nodeName) {
                                                ...
                                                b.push((new p).setValue(this.options._const.action, this.options._const.removeTextElement).setValue(this.options._const.route, i.concat(_)).setValue(this.options._const.value, l.data)),
                                                h.splice(_, 1),
                                                f.splice(_, 1),
                                        ...
                                        "#text" === (l = m[v]).nodeName ? (b.push((new p).setValue(this.options._const.action, this.options._const.addTextElement).setValue(this.options._const.route, i.concat(_)).setValue(this.options._const.value, l.data)),
                                        h.splice(_, 0, !0),
                                        f.splice(_, 0, {
                                            nodeName: "#text",
                                            data: l.data
                                        }),
                                        g = Math.min(h.length, u.length)) : (b.push((new p).setValue(this.options._const.action, this.options._const.addElement).setValue(this.options._const.route, i.concat(_)).setValue(this.options._const.element, N(l))),
                                        h.splice(_, 0, !0),
                                        f.splice(_, 0, N(l)),
                                        g = Math.min(h.length, u.length));
                                    else if (h[_] !== u[v]) {
                                        ...
                                        (o = Math.min(r.newValue, f.length - r.length)) !== r.oldValue) {
                                            ...
                                            for (var y = 0; y < r.length; y += 1)
                                                O(f[o + y], f[r.oldValue + y], {}, !1, !0) || (a = !0);
                                            if (a)
                                                return [(new p).setValue(this.options._const.action, this.options._const.relocateGroup).setValue(this.options._const.groupLength, r.length).setValue(this.options._const.from, r.oldValue).setValue(this.options._const.to, o).setValue(this.options._const.route, i)]
                                        }
                                    }
                                } else
                                    ;
                        ...
                        t.prototype.findValueDiff = function(t, e, s) {
                            var i = [];
                            return t.selected !== e.selected && i.push((new p).setValue(this.options._const.action, this.options._const.modifySelected).setValue(this.options._const.oldValue, t.selected).setValue(this.options._const.newValue, e.selected).setValue(this.options._const.route, s)),
                            (t.value || e.value) && t.value !== e.value && "OPTION" !== t.nodeName && i.push((new p).setValue(this.options._const.action, this.options._const.modifyValue).setValue(this.options._const.oldValue, t.value || "").setValue(this.options._const.newValue, e.value || "").setValue(this.options._const.route, s)),
                            t.checked !== e.checked && i.push((new p).setValue(this.options._const.action, this.options._const.modifyChecked).setValue(this.options._const.oldValue, t.checked).setValue(this.options._const.newValue, e.checked).setValue(this.options._const.route, s)),
                            i
                        }
                        ,
                        t
                    ...
                    const F = (t, e, s, {classes: i, format: n, hiddenHeader: a, sortable: o, scrollY: r, type: l}, {noColumnWidths: d, unhideHeader: h}) => ({
                      ...
                      , q = (t, e, s, i, a, o, {classes: r, hiddenHeader: l, header: d, footer: h, format: u, sortable: p, scrollY: f, type: m, rowRender: g, tabIndex: b}, {noColumnWidths: v, unhideHeader: _, renderHeader: w}, y, D) => {
                        const M = {
                            nodeName: "TABLE",
                            attributes: {
                                ...t
                        ...
                        if (M.attributes.class = c(M.attributes.class, r.table),
                        d || h || w) {
                            const t = F(e, i, a, {
                                classes: r,
                                hiddenHeader: l,
                        ...
                        return y.forEach((t => M.childNodes.push(t))),
                    ...
                    class tt {
                        ...
                        add(t) {
                            ...
                            if (this.dt.data.headings = this.dt.data.headings.concat([Z(t.heading)]),
                    ...
                    const et = {
                      ...
                      , it = (t, e, s, i, n) => {
                        let a = [];
                        if (n.firstLast && a.push(st(1, n.firstText, n)),
                        n.nextPrev) {
                            const e = t ? 1 : s - 1;
                            ...
                            if (this.options.destroyable) {
                                if (this.wrapperDOM)
                                    if (this.wrapperDOM.parentElement) {
                                        ...
                                        this.wrapperDOM.parentElement.replaceChild(t.firstElementChild, this.wrapperDOM)
                                    } else
                            ...
                            if (Array.isArray(e)) {
                                ...
                                e.forEach(( (e, i) => {
                                    ...
                                    Object.entries(e).forEach(( ([e,s]) => {
                                        const a = t.indexOf(e);
                                        a > -1 ? n[a] = X(s, this.columns.settings[a]) : this.hasHeadings || this.hasRows || 0 !== i || (n[t.length] = X(s, this.columns.settings[t.length]),
                                        t.push(e),
